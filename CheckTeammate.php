        ...
        <div class="content-body">
			<div class="container-fluid">
                ...
                <div class="row page-titles mx-0">
					...
					$loginId=$_SESSION["LoginUserID"];
					$sql = 'SELECT user_id,user_name,email,phone_number,description FROM user,student_in_group where user.user_id=student_in_group.student_id AND user_id != "'.$loginId.'" AND group_id="'.$groupId.'" ';
					$rs = mysqli_query($conn, $sql);
					while ($rc = mysqli_fetch_assoc($rs)) {
						$user_name=$rc['user_name'];
						$user_email=$rc['email'];
						$phone=$rc['phone_number'];
						$descr=$rc['description'];
						$user_id=$rc['user_id'];
						if($user_id )
						echo'				<div class="row">
						<div class="col-lg-12">
								...
								<div class="profile-head">
									...
									<div class="profile-info">
										<div class="profile-photo">
											<img src="images/Untitled-1.jpg" class="img-fluid rounded-circle" alt="">
										</div>
										<div class="profile-details">
											<div class="profile-name px-3 pt-2">
												<h4 class="text-primary mb-0">'.$user_name.'</h4>
											</div>
											<div class="profile-email px-2 pt-2">
												<h4 class="text-muted mb-0">'.$user_email.'</h4>
												<p>Email</p>
											</div>
											<div class="profile-email px-2 pt-2">
										...
										<div class="profile-email px-2 pt-2">
										<h4 class="text-muted mb-0">'.$descr.'</h4>
										<p>Description</p>
									</div>
