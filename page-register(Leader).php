                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h4 class="text-center mb-4">Sign up your account(Supervisor)</h4>
                                      <div class="container">
...
<?php
    ...
    while($rc= mysqli_fetch_assoc($rs)){
      ...
      if($email==$rc['email']){
        ...
        $sql = "INSERT INTO user(user_name,password,email,role,phone_number) VALUES('".$name."','".$password."','".$email."','1','".$Phone."')" ;
